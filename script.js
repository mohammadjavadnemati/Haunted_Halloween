...
const WHEEL_SEGMENTS = [
  { label:'کندی تموم شده',              units:6.25, color:'#2b2b2b' },
  { label:'۲ تا کندی',                  units:16.3, color:'var(--green)' },
  { label:'دوباره بچرخون',              units:7.4,  color:'var(--purple)' },
  { label:'چه لباس قشنگی (۳ کندی)',     units:17.7, color:'var(--orange)' },
  { label:'کسی خونه نیست',              units:7.8,  color:'#2b2b2b' },
  { label:'۲ تا کندی بردار',            units:16,   color:'var(--green)' },
  { label:'دوباره بچرخون',              units:7.5,  color:'var(--purple)' },
  { label:'۱ کندی بردار + دوباره تاس',  units:14.7, color:'var(--orange)' },
];
function createWheelElement(){
  const el = document.createElement('div');
  el.className = 'wheel-final';
  return el;
}
